    ...
    <div className="space-y-6">
      ...
      <div className={`p-6 rounded-3xl border shadow-xl flex items-center justify-between flex-wrap gap-4 text-white ${
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-amber-100">Keep up your daily work cycle streak to unlock special badges!</p>
          </div>
        </div>

        <div className="flex items-center gap-4">
          <div className="bg-white/10 backdrop-blur-md px-4 py-2 rounded-2xl border border-white/20 text-center">
            <span className="text-[10px] text-amber-100 font-bold uppercase block flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className={`p-6 rounded-2xl border shadow-sm space-y-4 ${
            ...
            {!quizFinished ? (
              <div className={`p-5 rounded-2xl border space-y-4 text-xs ${
                ...
                {selectedOption !== null && (
                  <div className="pt-3 border-t border-slate-200 space-y-3">
                    <p className="text-xs text-amber-900 bg-amber-50 p-3 rounded-xl border border-amber-200 font-medium">
              ...
              <div className="bg-emerald-50 border border-emerald-200 p-6 rounded-2xl text-center space-y-3">
                ...
                <h4 className="font-extrabold text-lg text-emerald-900">Quest Completed!</h4>
                <p className="text-xs text-slate-700 font-medium">You earned total points and strengthened your Montessori concept mastery!</p>
                <button
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-br from-indigo-700 to-purple-800 p-5 rounded-2xl border border-indigo-500 shadow-lg space-y-3 text-white">
            <div className="flex items-center gap-2 font-bold text-xs">
              <Box className="w-5 h-5 text-indigo-200 animate-spin" style={{ animationDuration: '6s' }} />
