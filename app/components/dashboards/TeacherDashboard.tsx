...
import { 
  ...
  Sparkles, UserCheck, QrCode, FileText, HeartHandshake, Eye, DollarSign
} from 'lucide-react';
import AdminDashboard from './AdminDashboard';
import FinanceHrDashboard from './FinanceHrDashboard';

export default function TeacherDashboard() {
  const { 
    theme, activeTab, setActiveTab, activeTenant, students, selectedStudent, setSelectedStudentId,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Top Page Hierarchy Navigation Tabs */}
      <div className={`p-1.5 rounded-2xl border flex items-center gap-1.5 overflow-x-auto no-scrollbar shadow-sm ${
        ...
        >
          📚 Montessori Curriculum & Lesson Matrix
        </button>
        ...
        >
          ⏱️ Observation Stream ({observations.length})
        </button>
